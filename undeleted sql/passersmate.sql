...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 09:28 AM
...
(1, 3, 1, 1, '2018-09-21 05:49:26', NULL, 2);
...
(19, 16, 23, '', '', '2018-09-20 21:52:24', 0),
(20, 16, 23, 'Thank you', 'Passer', '2018-09-20 21:52:31', 0);
...
(186, NULL, 1, 'JobOffer', '3', 0),
(187, NULL, 1, 'JobOffer', '5', 0),
(188, NULL, 16, 'updateUserStatus', '1', 0),
(189, 23, NULL, 'updateUserStatus', '1', 0),
(190, 23, NULL, 'subscription', '1', 0),
(191, NULL, 16, 'JobOffer', '1', 0),
(192, 23, NULL, 'jobOfferSeeker', '3', 0),
(193, NULL, 16, 'JobOffer', '3', 0),
(194, NULL, 16, 'JobOffer', '5', 0),
(195, 23, NULL, 'subscription', '1', 0),
(196, NULL, 1, 'updateUserStatus', '5', 0),
(197, NULL, 1, 'updateUserStatus', '1', 0),
(198, 3, NULL, 'subscription', '1', 0),
(199, NULL, 1, 'JobOffer', '1', 0),
(200, 3, NULL, 'jobOfferSeeker', '3', 0),
(201, NULL, 1, 'JobOffer', '3', 0),
(202, NULL, 1, 'JobOffer', '5', 0),
(203, NULL, 1, 'JobOffer', '1', 0),
(204, NULL, 1, 'JobOffer', '1', 0),
(205, NULL, 1, 'JobOffer', '1', 0),
(206, 3, NULL, 'jobOfferSeeker', '3', 0),
(207, NULL, 1, 'JobOffer', '3', 1),
(208, NULL, 1, 'JobOffer', '5', 1);
...
(7, 3, 'qweqwe', '2020-01-11', '2022-01-11', 705, 'Online', 'In-House', 0, 2, 1),
(8, 23, 'General Gines St. Suba Cebu City', '2018-09-29', '2018-11-01', 500.25, 'Online', 'In-House', 0, 2, 1),
(9, 3, 'qwe', '2018-01-01', '2018-01-02', 252, 'Online', 'In-House', 1, 2, 1);
...
(1, 1, 'qwe', '2018-01-01', '2018-01-02', 252, 'Online', 'In-House', '', 1);
...
(15, 'syrel', 'prialde', '', NULL, 0, '', '', '', '', NULL, 'test@gmail.com', '0', 0, '', '0000-00-00', '$2y$12$zlFNjRLgMXptGbJ6QrrkNeroqmsro9FgqHGqy4EVynbOwtt0TSlzW', '', '', '', NULL, 0, '2018-09-20 15:45:00', 'Passer'),
(16, 'Maricon', 'Penaso', 'A', '1990-06-06', 28, 'Female', 'General Gines St.', 'Cebu City', 'Region Vii', 9154861084, 'penaso@gmail.com', '1', 0, '15130602042125', '2018-11-30', '$2y$12$mpBFqL2QeaczwUS3JMo0quDx2Wu2cprDdKs9TelVYOV9p8ZUc116K', 'Household Services NC II', 'NC II', 'http://www.tesda.gov.ph/Rwac/Details/7369024', '../../public/etc/images/user/passer/153748005871537480058616.jpg', 0, '2018-09-20 21:41:06', 'Passer');
...
(13, 16, '../../public/etc/images/userVerify/passer/153747973861537479738616.png', '../../public/etc/images/userVerify/passer/153747973851537479738116.png', '../../public/etc/images/userVerify/passer/153747973851537479738216.png', '../../public/etc/images/userVerify/passer/153747973861537479738316.png', 'Voter&rsquo;s ID', 1456789, '2018-11-30', '2018-09-20 21:42:18');
...
(12, 3, 1, 3, 3, 3, 3, '', 'Seeker', '2018-09-21 04:59:33'),
(13, 1, 1, 3, 3, 3, 3, '', 'Seeker', '2018-09-21 05:49:36');
...
(23, 'Vergie', 'Franco', '1979-10-16', 39, 'Female', 'Carlock St.', 'Cebu City', 'Region Vii', 9154861084, 'vergie@gmail.com', '', NULL, NULL, NULL, '', '1', '../../public/etc/images/user/seeker/153748001021537480010223.jpg', 'vergie101', '$2y$12$d9hzfrKoVH.MCMDdJagfs.frLfr8ehQX2AVIkbYgcY21ZnQJgZFKS', '2018-09-20 21:44:26', 'Seeker');
...
(6, 23, '../../public/etc/images/userVerify/seeker/1537479927101537479927123.png', '../../public/etc/images/userVerify/seeker/153747992741537479927523.png', '../../public/etc/images/userVerify/seeker/153747992711537479927223.png', 'Philippine Passport', 123123123, '2019-02-28', '2018-09-20 21:45:27');
...
(7, 1, 23, '2018-09-20', '2018-09-21', 'paypal', 'ongoing'),
(8, 1, 23, '2018-09-21', '2018-09-22', 'paypal', 'ongoing'),
(9, 3, 3, '2018-09-21', '2019-09-21', 'paypal', 'ongoing');
...
(1, 1, 0, 1, 'Seeker', '2018-09-21 05:22:42'),
(2, 1, 1, 3, 'Passer', '2018-09-21 05:22:42'),
(3, 1, 3, 5, 'Seeker', '2018-09-21 05:45:10'),
(4, 1, 5, 9, 'Seeker', '2018-09-21 05:49:27');
...
--
ALTER TABLE `notification`
  MODIFY `notificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
...
--
ALTER TABLE `offerjobform`
  MODIFY `OfferJobFormID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `passer`
  MODIFY `PasserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `passervalidate`
  MODIFY `passerValidateId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `ratings`
  MODIFY `RatingsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `seeker`
--
ALTER TABLE `seeker`
  MODIFY `SeekerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `seekervalidate`
--
ALTER TABLE `seekervalidate`
  MODIFY `SeekerValidateId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `subscription`
--
ALTER TABLE `subscription`
  MODIFY `SubscriptionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `switch`
  MODIFY `SwitchID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `transactionhistory`
  MODIFY `TransactionHistory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
