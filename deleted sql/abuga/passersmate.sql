...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 11:21 PM
...
(1, 'Jodel', 'Adan', 'B', '1997-09-01', 0, 'Male', 'General Gines St.', 'Cebu City', 'Cebu', 9154861084, 'test@gmail.com', '1', 1, '13040102003962', '0000-00-00', '$2y$12$c8IJg1yqxeT8kwdtFNg1a.vJI3aRp6LDHpBNzLFzehwYULvzhP1wy', 'CNC MILLING MACHINE OPERATION NC II', 'NC II', 'http://www.tesda.gov.ph/Rwac/Details/7369195', '../../public/etc/images/user/passer/15325417363153254173631.png', 580, '2018-07-22 15:12:46', 'Passer'),
...
(15, 'syrel', 'prialde', '', NULL, 0, '', '', '', '', NULL, 'test@gmail.com', '2', 0, '', '0000-00-00', '$2y$12$zlFNjRLgMXptGbJ6QrrkNeroqmsro9FgqHGqy4EVynbOwtt0TSlzW', '', '', '', NULL, 0, '2018-09-21 21:09:29', 'Passer');
...
(15, 1, 'Kindergarten', 'Abada Colleges', 'wqeqweqw');
...
(13, 15, '../../public/etc/images/userVerify/passer/153756437971537564379615.png', '../../public/etc/images/userVerify/passer/153756437911537564379315.png', '../../public/etc/images/userVerify/passer/1537564379101537564379515.png', '../../public/etc/images/userVerify/passer/1537564379101537564379115.png', 'Philippine Passport', 123123, '2018-12-30', '2018-09-21 21:12:59');
...
--
ALTER TABLE `passer`
  MODIFY `PasserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Constraints for table `seekercompany`
--
ALTER TABLE `seekercompany`
  ADD CONSTRAINT `seekercompany_ibfk_1` FOREIGN KEY (`seekerID`) REFERENCES `seeker` (`SeekerID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
