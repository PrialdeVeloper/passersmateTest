                	...
                	<div class="col-sm-4 mt-5">
                		<div class="card shadow">
                			...
                			<div class="card-body mt-3" style="font-size:20px">
                			 <ul class="fa-ul">
				              <li><span class="fa-li"><i class="fas fa-check text-success"></i></span>25 passers</li>
				              <li><span class="fa-li"><i class="fas fa-check text-success"></i></span>25 Job Offers</li>
