...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('../../public/etc/images/system/background1.jpg');">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							<img class="logo" src="../../public/etc/images/system/logo-2.png" alt="logo">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h2 class="white-text">SEEK IT OUT AND YOU SHALL FIND</h2>
								<h3 class="white-text transpa">Where Opportunities Create Doors For You</h3>
	...
	<div id="numbers" class="section sm-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('../../public/etc/images/system/background2.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
	...
	<div id="testimonial" class="section md-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('../../public/etc/images/system/background4.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="../../public/etc/images/system/syrel.jpg" alt="">
							<div class="overlay">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="../../public/etc/images/system/marvee.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="../../public/etc/images/system/joel.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<a href="index.html"><img src="../../public/etc/images/system/logo-alt.png" alt="logo"></a>
					</div>
					<!-- /footer logo -->
