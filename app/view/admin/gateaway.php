            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Payment Gateaway</h4>
                        ...
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-header bg-primary text-white">
                                    <h4 class="card-title">View Gateaway</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="packageName" class="col-sm-3 control-label col-form-label">Gateaway Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="getawayName" value="Paypal" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="packagePrice" class="col-sm-3  control-label col-form-label">PayPal Email Address</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="paypalEmail" value="passersmate@gmail.com" disabled>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modal1">Update</button>
                                    </div>
                                </div>
                                  <!-- Modal -->
                                <div class="modal fade" id="Modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
                                    <div class="modal-dialog" role="document ">
                                        <div class="alert alert-success" role="alert">
                                            Payment Gateaway Updated Successfully!
