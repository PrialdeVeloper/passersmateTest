            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">General Account Settings</h4>
                        <div class="ml-auto">
                               ...
                               <!--  <div class="card-header bg-primary text-white">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="fullname" class="col-sm-3 control-label col-form-label">Name</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control is-valid" id="fullname" value="Marvee Franco" disabled>
                                             <div class="valid-feedback">
                                              Looks good!
                                            </div>
                                        </div>
                                          <div class="col-sm-2">
                                            <a href="" class="text-info"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="fullname" class="col-sm-3 control-label col-form-label">Username</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="fullname" value="Marvee Franco" disabled>
                                        </div>
                                          <div class="col-sm-2">
                                            <a href="" class="text-info"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        </div>
                                     ...
                                     <div class="form-group row">
                                        <label for="fullname" class="col-sm-3 control-label col-form-label">Password</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="fullname" value="Marvee Franco" disabled>
                                        </div>
                                    </div>
                                       <div class="form-group row">
                                        <label for="fullname" class="col-sm-3 control-label col-form-label">Retype Password</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="fullname" value="Marvee Franco" disabled>
                                        </div>
                                    </div>
