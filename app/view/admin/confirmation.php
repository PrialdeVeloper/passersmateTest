                ...
                <div class="row">
                    ...
                    <div class="card">
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class=""><a href="" data-toggle="modal" data-target="#Modal3"><span class="badge badge-warning">1</span></a></td>
                                        <td class="">Syrel Prialde</td>
                                        <td class="">syrelgm@gmail.com</td>
                                        <td class="">Passer</td>
                                    ...
                                    <div class="p-20">
                                         <div class="card-body">
                                                <div class="card border shadow">
                                                     <img src="../../assets/images/big/img4.jpg" alt="user" width="100%">
                                                      <div class="card-body">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-3 control-label col-form-label">Type of ID</label>
                                                <div class="col-sm-9">
                                                <input type="text" class="form-control" id="cocnumber" value="Student ID" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-3 control-label col-form-label">Expiration Date</label>
                                          ...
                                          <div class="border-top">
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-dark">Denied</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
