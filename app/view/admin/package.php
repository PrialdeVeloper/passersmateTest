                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="packageName" class="col-sm-3 control-label col-form-label">Package Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="packageName" placeholder="Package Name Here">
                                        </div>
                                    </div>
                                       <div class="form-group row">
                                        <div class="col-12">
                                            <!-- Create the editor container -->
                                            <label for="editor" class="col-sm-3 control-label col-form-label"> Features</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="packagePrice" class="col-sm-3  control-label col-form-label">Package Price</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="packagePrice" placeholder="Price here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="numberPasser" class="col-sm-3  control-label col-form-label">Number of Passers</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="numberPasser" placeholder="Usage/Duration">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3">Package Billing</label>
                                        <div class="col-md-9">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation1" name="radio-stacked" required>
                                                <label class="custom-control-label" for="customControlValidation1">One time</label>
                                            </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation2" name="radio-stacked" required>
                                                <label class="custom-control-label" for="customControlValidation2">Weekly</label>
                                            </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation2" name="radio-stacked" required>
                                                <label class="custom-control-label" for="customControlValidation2">Monthly</label>
                                            </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation2" name="radio-stacked" required>
                                                <label class="custom-control-label" for="customControlValidation2">Yearly</label>
                                            </div>
                                        </div>
                                     </div>
                                     <div class="form-group row">
                                        <label class="col-md-3 ">Show Package?</label>
                                        <div class="col-md-9">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="customControlValidation1" name="radio-stacked" required>
                         ...
                         <div class="alert alert-success" role="alert">
                            New Package is Added Successfully!
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>weekly</th>
                                                <td>
                                                    <span class="badge badge-warning">Not Shown</span>
                                                </td>
                                                <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Update Package <i class=" fas fa-pencil-alt"></i></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="packageName" class="col-sm-3 control-label col-form-label">Package Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="packageName" value="Basic">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="packagePrice" class="col-sm-3  control-label col-form-label" value="Php55.00">Package Price</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="packagePrice" placeholder="Price here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="numberPasser" class="col-sm-3  control-label col-form-label">Number of Passers</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="numberPasser" value="2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3">Package Billing</label>
