...
if(isset($data) && !empty($data)){
    extract($data[0]);
    if(isset($passerUnverified) && !empty($passerUnverified)){
        $domPasserUnverified = $passerUnverified;
    }
}
?>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">TESDA-Competency</span></a> </li>
                                    ...
                                    <div class="p-20">
                                         <div class="card-body">
                                            <div class="card border shadow">
                                                 <img name="passerProfile" src="../etc/admin/assets/images/big/img4.jpg" alt="user" width="100%">
                                                  <div class="card-body">
                                            ...
                                            <form class="form-horizontal">
                                              <!--   <div class="card-header text-white">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="fname" value="Marvee" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                ...
                                <div class="tab-pane  p-20" id="profile" role="tabpanel">
                                    <div class="p-20">
                                        <div class="row">
                                            <div class="col-md-12">
                                            <div class="card border shadow">
                                                <img name="cocPic" src="../etc/admin/assets/images/big/img4.jpg" alt="user" width="100%">
                                                <div class="card-body">
                                                    <p class="card-text"><b>Certificate of Competency Assessment</b></p>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="border-top">
                                            <div class="card-body">
                                                <button type="button" name="verifyPasser" class="btn btn-success verifyPasser">Verify</button>
                                                <button type="button" name="denyPasser" class="btn btn-dark denyPasser">Denied</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
