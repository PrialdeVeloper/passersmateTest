...
<body>
                        ...
                        <div class="col-md-4 mx-auto   mt-5">                      
                          <div class="card shadow">
                            <div class="card-header">
                              <h5><i class="fas fa-user"></i> Employment Agreement with #SeekersNAME <small class="text-success"><h5>Created August 06, 2018</h5></small></h5>
                            </div>
                            <hr>
                            <div class="card-body">
    ...
    <?php
    require "modal/agreementRecordModal.html";
    ?>